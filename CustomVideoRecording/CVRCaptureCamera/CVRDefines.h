...
//
//  Created by xiets on 14-1-25.
//  Copyright (c) 2014年 xietingsong. All rights reserved.
//


/**
 *  相机：CVRCameraController needs four frameworks:
...
#define CVRDLog(x, ...) NSLog(x, ## __VA_ARGS__);
#else
#define CVRDLog(x, ...)
#endif

#define LINE_COLOR       [UIColor colorWithRed:30/255.0f green:185/255.0f blue:204/255.0f alpha:1.f]
...
//frame and size
#define SN_DEVICE_BOUNDS    [[UIScreen mainScreen] bounds]
#define SN_DEVICE_SIZE      [[UIScreen mainScreen] bounds].size

#define SN_APP_FRAME        [[UIScreen mainScreen] applicationFrame]
#define SN_APP_SIZE         [[UIScreen mainScreen] applicationFrame].size
